...
const RelatedProducts = ({ category, title }) => {
  ...
  // const related__products = products_data.filter(data => words.some(s =>
  //  data.title.toLowerCase()
  // .includes(s.toLowerCase())))
  // console.log(related__products);

  const relatedItems = products_data.filter(
          ...
          <div className="row justify-content-center">
            <div className="col-xl-10">
              <div className="tp-product-slider-title">
                <h3 className="tp-product-slider-title pb-45">
                  Realated Product
                </h3>
              </div>
            </div>
              ...
              {relatedItems.length <= 3 && (
                <div className="row">
                  {relatedItems.map((item) => {
                    ...
                    const isCartSelected = cart_products.find(
                      (i) => i.id === id
                    );
                    ...
                    return (
                      <div key={id} className="col-xl-4 col-md-6 col-12">
