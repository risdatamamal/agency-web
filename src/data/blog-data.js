const blog_data = [
  {
    ...
    short_desc:
      "At Javaprojects we specialize in designing, building, shipping and scaling beautiful, usable products with blazing-fast",
    duration: ".6s",
    delay: ".4s",
    home: true,
  },
  ...
  // home three
  {
    ...
    short_desc:
      "At Javaprojects we specialize in designing, building, shipping and scaling beautiful",
    duration: ".3s",
    delay: ".6s",
    home_3: true,
  },
  ...
  // home 4
  {
    ...
    title: "Godaddy user flow solution.",
    short_desc:
      "At Javaprojects we specialize in designing, building, shipping and scaling beautifu. At Javaprojects we specialize in designing, building, shipping and scaling beautiful.",
    big: true,
    home_4: true,
  },
  {
  ...
  // home 5
  {
    ...
    title: (
      <>
        Godaddy user flow solution <br /> for every individual
      </>
    ),
    short_desc:
      "At Javaprojects we specialize in designing, building, shipping and scaling beautifu. At Javaprojects we specialize in designing, building, shipping and scaling beautiful.",
  ...
  // home 6
  {
    ...
    short_desc: (
      <>
        Nam eget dui vel quam sodales semper quis <br /> porttitor tortor.
        Vivamus
      </>
    ),
    duration: ".3s",
